...
import { Bot, Code2Icon, CreditCard, GitCommitHorizontal, LayoutDashboard, Plus, Presentation } from "lucide-react"
        ...
        <Sidebar collapsible="icon" variant="floating" >
            <SidebarHeader>
                <div className="flex items-center gap-2">
                    ...
                    {open && <h1 className="text-xl font-bold text-primary/80">GitWay</h1>}
                </div>
            </SidebarHeader>
            <SidebarContent>
                <SidebarGroup>
